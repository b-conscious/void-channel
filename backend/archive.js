...
// Surfaced live + de-flooded; CSA/hate still hard-block (search runs dropExcluded); off the commercial
// wall, gated only by the one-time 18+ acknowledgment.
const ADULT_ROWS = [
  { id: 'adult_stag',      name: 'The Stag Era',       subtitle: '1900s to 1940s · silent stag reels and roughies, the underground beginning', query: '(subject:("stag film") OR subject:(stag) OR subject:(roughie) OR subject:(roughies)) AND mediatype:(movies)' },
  { id: 'adult_burlesque', name: 'Burlesque & Pin-Up', subtitle: '1930s to 1950s · burlesque stages, pin-up and peep-show reels',             query: '(subject:(burlesque) OR subject:("pin-up") OR subject:(pinup) OR subject:("peep show")) AND mediatype:(movies)' },
  { id: 'adult_nudie',     name: 'Nudie Cuties',       subtitle: '1960s · the nudie-cutie boom',                                                query: '(subject:("nudie cutie") OR subject:("nudie cuties") OR subject:(nudie) OR subject:(nudist)) AND mediatype:(movies)' },
  { id: 'adult_exploit',   name: 'Sexploitation',      subtitle: '1970s · grindhouse and the golden age',                                       query: '(subject:(sexploitation) OR subject:(exploitation) OR subject:(grindhouse)) AND mediatype:(movies)' },
  { id: 'adult_features',  name: 'Adult Films',        subtitle: 'Feature-length adult cinema, the explicit canon (the films themselves, not sliced by act)', query: '(subject:(pornographic) OR subject:(pornography) OR subject:("adult film") OR subject:(xxx) OR subject:(hardcore) OR subject:("blue movie")) AND mediatype:(movies)' },
  { id: 'adult_erotica',   name: 'Erotica & Art',      subtitle: 'Erotic art and film across the eras',                                         query: '(subject:(erotica) OR subject:(erotic) OR subject:("erotic film")) AND mediatype:(movies)' },
];
